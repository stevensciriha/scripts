...
#PCRF Section
spawn scp root@$PCRF_HOST:$PCRF_PATH/*$date*.tar $local_backup_dir_PCRF
expect {
...
#DRA Section
spawn scp root@$DRA_HOST:$DRA_PATH/*$date*.tar $local_backup_dir_DRA
expect {
...
#BMS Section
spawn scp root@$BMS_HOST:$BMS_PATH/*$date*.tar $local_backup_dir_BMS
expect {
...
spawn scp admin@$SWITCH_HOST:getcfg $local_backup_dir_SWITCH\getcfg-$date-$SWITCH_HOST
expect {
...
spawn scp admin@$SWITCH_HOST:getimg1 $local_backup_dir_SWITCH\getimg1-$date-$SWITCH_HOST
expect {
        "password:" {send "$SWITCH_PASS\r";exp_continue}
        "yes/no)?" {send "yes\r"; expect "password:" {send "$SWITCH_PASS\r";exp_continue}}
        eof
...
spawn scp admin@$SWITCH_HOST:getimg2 $local_backup_dir_SWITCH\getimg2-$date-$SWITCH_HOST
expect {
        "password:" {send "$SWITCH_PASS\r";exp_continue}
        "yes/no)?" {send "yes\r"; expect "password:" {send "$SWITCH_PASS\r";exp_continue}}
        eof
...
spawn scp admin@$SWITCH_HOST:getboot $local_backup_dir_SWITCH\getboot-$date-$SWITCH_HOST
expect {
        "password:" {send "$SWITCH_PASS\r";exp_continue}
        "yes/no)?" {send "yes\r"; expect "password:" {send "$SWITCH_PASS\r";exp_continue}}
        eof
